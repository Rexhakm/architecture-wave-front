...
export default function AllProductsPage() {
  ...
  // Inject checkbox styles on client side to avoid hydration error
  useEffect(() => {
  ...
  return (
    <>
      <main className="w-[calc(100%-20px)] sm:w-[calc(100%-40px)] mx-auto px-2 sm:px-4 bg-white rounded-2xl pb-12 sm:pb-24 min-h-[calc(100vh-690px)]" style={{ fontFamily: 'var(--font-mazzard-soft)', borderRadius: '45px', marginBottom: 40, position: 'relative', zIndex: 1 }}>
        ...
        <div className="ml-0 sm:ml-[100px] sm:mr-[92px]">
          {/* Page Header Section */}
                    ...
                    if (category.categorySlug) {
                      return (
                        <Link
                          ...
                          className="w-full text-left py-2 rounded block bg-transparent text-black"
                          style={{ fontFamily: 'var(--font-mazzard-soft)' }}
                        >
                          {category.name}
                        </Link>
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-left py-2 rounded bg-transparent text-black"
                          style={{ fontFamily: 'var(--font-mazzard-soft)' }}
                        >
                          {category.name}
                        </button>
